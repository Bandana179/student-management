  ...
  <body>
    ...
    <div class="content">
        <div class="wrapper">
            ...
            <form method="POST" action="/routineedit">
               @csrf
            <div class="form">
               <input type="hidden" name="id"  value="{{$data['routine_id']}}">
               <div class="inputfield">
                  <label>Subject</label>
                  <input type="text" name="subject" class="input" value="{{$data['subject']}}">
               </div>
               <div class="inputfield">
                <label>Day</label>
                <input type="text" name="day" class="input"  value="{{$data['day']}}" >
             </div>   
                <div class="inputfield">
                  <label>Class Id</label>
                  <input type="text" name="class_id" class="input"  value="{{$data['class_id']}}">
               </div>  
               <div class="inputfield">
